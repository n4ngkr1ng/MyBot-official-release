			...
			If $body <> "" Or $iden <> "" Then
				...
				Switch $body[$x]
					Case GetTranslated(620,1, "BOT") & " " & GetTranslated(620,14, "HELP")
						...
						$txtHelp &= '\n' & GetTranslated(620,1, -1) & " " & GetTranslated(638,21,"ACC <acc list>") & GetTranslated(638,26, " - set new play list")
						...
						$txtHelp &= '\n' & GetTranslated(620,1, -1) & " " & GetTranslated(638,24,"MAP <acc number>-<pro number>") & GetTranslated(638,29, " - set profile to an account. eg: BOT MAP 1-3")
						$txtHelp &= '\n' & GetTranslated(620,1, -1) & " " & GetTranslated(638,25,"MODE <mode ID>") & GetTranslated(638,30, " - set switching mode. Eg: BOT MODE 0")
						$txtHelp &= '\n' & GetTranslated(620,1, -1) & " " & GetTranslated(638,2,"PRO <pro number>") & GetTranslated(638,12, " - set new bot profiles")
						...
						$txtHelp &= '\n' & GetTranslated(620,1, -1) & " " & GetTranslated(638,5,"ALLPRO <all pro number>") & GetTranslated(638,15, " - set up profiles correspond to all exists accounts")
